	...
	<div class="center">
		<div class="col_12">
			...
			<?php if (isset($success)): ?>
				...
				<ul>
					<li><?php echo __('Successfully Registered This River on Instagram'); ?></li>
				</ul>
				</div>
			<?php endif; ?>
				...
				<section class="property-parameters">
					<div class="parameter">
						<label for="client_id">
							...
							<?php echo Form::input('client_id', $client_id); ?>
						</label>
					</div>
					...
					<div class="parameter">
						<label for="client_secret">
							...
							<?php echo Form::input('client_secret', $client_secret); ?>
						</label>
					</div>
				</section>
			</article>
